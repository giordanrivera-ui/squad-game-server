          ...
          child: Padding(
            ...
            child: ValueListenableBuilder<Map<String, dynamic>>(
              ...
              builder: (context, stats, child) {
                ...
                return Column(
                  children: [
                    // ==================== EXISTING STRENGTH + STEALTH SECTION ====================
                    Expanded(
                      child: Row(
                        children: [
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  padding: const EdgeInsets.symmetric(vertical: 10),
                                  child: const Center(
                                    child: Text('Stealth\nTraining', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: Colors.white)),
                                  ),
                                ),
                                const SizedBox(height: 12),
    ...
    SocketService().socket?.once('training-result', (data) {
      if (data is Map && mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(message), backgroundColor: success ? Colors.green[700] : Colors.red[700], duration: const Duration(seconds: 2)),
        );
      }
    });
  }
